...
func TestDemoLocale(t *testing.T) {
	for _, tt := range DemoLocale(&bc.BaseComponent{EventURL: "/demo"}) {
		t.Run(tt.Label, func(t *testing.T) {
			tt.Component.Render()
		})
	}
	demoLocaleResponse(bc.ResponseEvent{Name: LocalesEventError, Trigger: &Locale{}})
	demoLocaleResponse(bc.ResponseEvent{Name: LocalesEventSave, Trigger: &Locale{}})
	demoLocaleResponse(bc.ResponseEvent{Name: LocalesEventUndo, Trigger: &Locale{}})
}
...
func TestLocale_Validation(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			args: args{
				propName:  "locales",
				propValue: []fm.SelectOption{},
			},
			want: []fm.SelectOption{{Value: "default", Text: "default"}},
		},
	}
